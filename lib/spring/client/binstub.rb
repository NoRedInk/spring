...
unless defined?(Spring)
  ...
  spring = lockfile.specs.detect { |spec| spec.name == 'nrispring' }
  if spring
    Gem.use_paths Gem.dir, Bundler.bundle_path.to_s, *Gem.path
    gem 'nrispring', spring.version
    require 'spring/binstub'
  end
end
CODE

      OLD_BINSTUB = %{if !Process.respond_to?(:fork) || Gem::Specification.find_all_by_name("nrispring").empty?}
